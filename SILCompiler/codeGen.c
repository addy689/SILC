...
/*							*/
/*							Ltable = NULL;*/
/*							argInstallLocal(gnode->ARGLIST,&Lhead);	//Function Arguments have been installed*/
/*							localDecInstall(root->Ptr2,&Lhead);	//Function local declarations have been installed*/
/*							*/
/*							printf();*/
/*	*/
/*	case MAINBLOCK		:	localDecInstall(root->Ptr2,&Lhead);*/
}
...
/*								*/
/*								else LinstallBind(root->NAME,argnode->TYPE,Lhead);*/
/*								*/
/*								break;*/
/*	}*/
}
